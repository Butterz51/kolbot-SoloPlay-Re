 ...
 */
  ...
  const NameGen = function () {
    if (Developer.GlobalSettings.Enable && Developer.GlobalSettings.Name.length > 0) {
      //include("SoloPlay/Functions/GlobalManagement/GlobalCharacter.js");
      return getGlobalCharacter();
    } else {
