...
const Developer = {
  ...
  GlobalSettings: {
    Account: "", // Set a value for a global accounts. (MAX Characters 12 plus Suffix Length)
    Password: "", // Set a value for a global password for account generation.
    Enable: false, // Set to true to use the "Character Name" feature.
  ...
  //@desc - show game names in the D2Bot# status window
